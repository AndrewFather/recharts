...
#'
#' Set the theme of Echarts. \cr
#' When an echart object is generated, you can modify it by setting toolbox using
#' \code{\link{\%>\%}}.
#'
#' @param chart \code{echarts} object generated by \code{\link{echart}} or \code{\link{echartR}}
#' @param theme \code{'default', 'macarons', 'infographic', 'blue', 'dark', 'gray',
#' 'green', 'helianthus', 'macarons2', 'mint', 'red', 'roma', 'sakura', 'shine'}
#' @param ... Elipsis
#'
#' @return A modified echarts object
...
#' @examples
#' \dontrun{
#' g <- echartR(iris, Sepal.Width, Petal.Width)
